...
namespace WakfuMod.Content.Items.Armor.Vanity.Pinpan // Ajusta el namespace
{
    ...
    // automáticamente el sprite llamado "YugoHead_Head.png" en la misma carpeta.
    [AutoloadEquip(EquipType.Head)]
    public class PinpanHead : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            // Item.headSlot = EquipLoader.GetEquipSlot(Mod, Name, EquipType.Head); // AutoloadEquip lo hace automáticamente
        }
